...
let friendsName: string [] = ["shamir", "wajahat", "affan", "hammad", "awais"];
...
let Guest_List: string [] = ["Hafsa", "irhsa", "Mahanoor"];
...
let places : string[] = ['Bankok', 'Africa', 'Dubai', 'England', 'Crotia'];
...
let list_OF_Countries: string[] = ['UAE', 'USA', 'Australia', 'UK', 'Maldives'];
...
let places: string []= ['Saddar','Karsaz','Nazimabad','Board Office'];
...
console.log( ("LAPTOP") as string === "COMPUTER");
...
console.log((5) as number  === 6 || 10 < 5);

//Test whether an item is in a array For True Result;

let places:string[] = ['KARACHI', 'ISLAMABAD', 'LAHORE', 'MULTAN'];
...
let fruits:string[]= ['ORANGE', 'BANANA','APPLE','STRAWBERRY']
...
// • Otherwise, print a generic greeting, such as Hello Eric, thank you for logging in again.
    ...
    let usernames: string [] = ['admin', 'shamir','ayaz','zubair','hamza']; 
...
let current_users: string [] = ['ali', 'Haris', 'bilal','Salman', 'Shahbaz']; 
let new_users: string [] = ['Wail','ali','Wasif','bilal','Muneer'];
...
let favorite_pizza: string [] = ['pepperoni pizza','veg pizza','fajita pizza']
...
function make_great2(magicians:string[]): string [] {
    ...
    let magicians2: string [] = ['Harry Houdini','David Blaine','Derren Brown','Dynamo']
...
let object: car = cars("toyota", 2024)
console.log(object);
